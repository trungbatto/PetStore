...
public class LoginScene extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        loginButton.setOnAction(e -> {
            ...
            Manager m = DAOManager.authenticateManager(username, password);
            if (u != null) {
            ...
            else if (m != null)
            {
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Success");
                alert.setHeaderText("Welcome to Pet Management");
                alert.setContentText("You have successfully logged in.");
                alert.showAndWait();
                openManagerTab(primaryStage);
            }
            else {
    ...
    private void openManagerTab(Stage primaryStage)
    {
        ManagerTabs mApp = new ManagerTabs();
        Stage stage = new Stage();
        mApp.start(stage);
